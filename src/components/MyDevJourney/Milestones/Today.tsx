...
export const Today = () => (
  <article className="today">
    <div>
      <h1 className="text-gradient-lime">Today</h1>
      <p>
        I want to work as a Mobile Developer or as a Web Developer, and emmigrate from Brazil with
        my girlfriend Lara and our cat Panda
      </p>
    </div>
    <aside>
      <picture>
